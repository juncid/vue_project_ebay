                ...
                <div class="comp">
                    <div class="tmpl routeanimate">
                        ...
                        <div class="section clearfix">
                            ...
                            <div class="right-auto"  v-if="orderinfo">
                                <div class="bg-wrap" style="min-height: 765px;">
                                    ...
                                    <div class="order-progress">
                                        <ul>
                                            <li class="first active">
                                                ...
                                                <div class="info">{{orderinfo.add_time | cutTime('YYYY-MM-DD hh:mm:ss')}}</div>
                                            </li>
                                            <li class="">
                                    ...
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link v-if="orderinfo.status==1" :to="'/orderInfo/'+orderid">去付款</router-link>
                                    ...
                                    <div class="table-wrap" v-if="goodslist.length!=0">
                                    ...
                                    <div class="form-box accept-box" v-if="orderinfo">
                                        <dl class="head form-group">
                                            <dd>收货信息</dd>
                                        </dl>
                                        <dl class="form-group">
...
export default {
    ...
    created() {
        ...
        console.log(`site/validate/order/getorderdetial/${this.orderid}`);
